...
import me.undergroundminer3.uee4.util.ColorHelper;
...
public class ItemAlchemicalBag extends ItemEE implements IDyeable
{
    ...
    public ItemStack onItemRightClick(ItemStack itemStack, World world, EntityPlayer entityPlayer)
    {
        if (!world.isRemote)
        {
            ...
            entityPlayer.openGui(UnequalExchange4.instance, GuiIds.ALCHEMICAL_BAG, entityPlayer.worldObj, (int) entityPlayer.posX, (int) entityPlayer.posY, (int) entityPlayer.posZ);
        }
